...
public class CACConfiguredFeatures {
    ...
    static {
        ...
        PILLOW_LAVA_PATCH = register("pillow_lava_patch", Feature.VEGETATION_PATCH.configured(new VegetationPatchConfiguration(BlockTags.MOSS_REPLACEABLE.getName(), (new WeightedStateProvider(weightedBlockStateBuilder().add(CACBlocks.PILLOW_LAVA.defaultBlockState(), 5).add(CACBlocks.CRUMBLY_STONE.defaultBlockState(), 4).add(Blocks.DEEPSLATE.defaultBlockState(), 15))), () -> MAGMATIC_VENTS, CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F)));
