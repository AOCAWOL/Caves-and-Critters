...
public class CACConfiguredFeatures {
    ...
    static {
        ...
        PERIDOT = register("peridot", Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(new WeightedStateProvider(weightedBlockStateBuilder().add(CACBlocks.PERIDOT_CLUSTER.defaultBlockState().setValue(AmethystClusterBlock.FACING, Direction.DOWN), 4).add(CACBlocks.SMALL_PERIDOT_BUD.defaultBlockState().setValue(AmethystClusterBlock.FACING, Direction.DOWN), 7).add(CACBlocks.MEDIUM_PERIDOT_BUD.defaultBlockState().setValue(AmethystClusterBlock.FACING, Direction.DOWN), 25).add(CACBlocks.LARGE_PERIDOT_BUD.defaultBlockState().setValue(AmethystClusterBlock.FACING, Direction.DOWN), 50).add(CACBlocks.PERIDOT_CLUSTER.defaultBlockState().setValue(AmethystClusterBlock.FACING, Direction.DOWN), 10)))));
        CRUMBLY_STONE = register("crumbly_stone", (ConfiguredFeature)((ConfiguredFeature)((ConfiguredFeature)Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, CACBlocks.CRUMBLY_STONE.defaultBlockState(), 64)).rangeUniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(16))).squared()).count(2));
        DRIPSTONE_VEGETATION = register("dripstone_vegetation", Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(new WeightedStateProvider(weightedBlockStateBuilder().add(Blocks.POINTED_DRIPSTONE.defaultBlockState(), 4).add(Blocks.CAVE_AIR.defaultBlockState(), 7).add(Blocks.CAVE_AIR.defaultBlockState(), 25).add(Blocks.CAVE_AIR.defaultBlockState(), 50).add(Blocks.POINTED_DRIPSTONE.defaultBlockState(), 10)))));
        PILLOW_LAVA_PATCH = register("pillow_lava_patch", Feature.VEGETATION_PATCH.configured(new VegetationPatchConfiguration(BlockTags.MOSS_REPLACEABLE.getName(), (new WeightedStateProvider(weightedBlockStateBuilder().add(CACBlocks.PILLOW_LAVA.defaultBlockState(), 4).add(CACBlocks.CRUMBLY_STONE.defaultBlockState(), 7))), () -> DRIPSTONE_VEGETATION, CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F)));
