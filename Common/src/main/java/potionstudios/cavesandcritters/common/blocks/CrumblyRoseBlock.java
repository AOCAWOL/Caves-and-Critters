...
public class CrumblyRoseBlock extends FlowerBlock implements BonemealableBlock {
    ...
    protected boolean mayPlaceOn(BlockState blockState, BlockGetter blockGetter, BlockPos blockPos) {
        return blockState.is(CACBlocks.CRUMBLY_STONE.get()) || blockState.is(CACBlocks.ROOTED_CRUMBLY_STONE.get()) || super.mayPlaceOn(blockState, blockGetter, blockPos);
    }

    public boolean isValidBonemealTarget(BlockGetter blockGetter, BlockPos blockPos, BlockState blockState, boolean bl) {
        return blockGetter.getBlockState(blockPos.below()).is(CACBlocks.CRUMBLY_STONE.get());
    }
    ...
    public void performBonemeal(ServerLevel serverLevel, Random random, BlockPos blockPos, BlockState blockState) {
        ...
        serverLevel.neighborChanged(blockPos.below(), CACBlocks.ROOTED_CRUMBLY_STONE.get(), blockPos);
